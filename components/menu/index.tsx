        ...
        <nav className={styles.navbar}>
            ...
            <div className={styles.navbar__bottom}>
                <div className={styles.navbar__logo}>
                    <Image src={menu.data.logoimage} className={styles.navbar__logo_img} alt="LOGO" />
                    <Image src={menu.data.logotext} className={styles.navbar__logo_img_1} alt="LOGOTXT" />
                </div>
                <div className={styles.navbar__menu}>
                    ...
                    <Image src={menu.data.icons.phone} alt="hamburguer_Menu_Mobile" className={styles.navbar__menu_iconMobile} />
                    <Image src={menu.data.logotext} alt="Logo_Menu_Mobile" className={`${styles.navbar__menu_iconMobile} ${styles.navbar__menu_iconMobile_logo}`} />
                    <Image src={menu.data.icons.hamburger} alt="Phone_Menu_Mobile" className={styles.navbar__menu_iconMobile} />
                </div>
            </div>
        </nav>
    );
